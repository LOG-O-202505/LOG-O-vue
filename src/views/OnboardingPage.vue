<template>
      ...
      <section class="popular-destinations">
        ...
        <div class="destinations-preview">
          <div class="destination-card">
            <div class="destination-image jeju"></div>
          ...
          <div class="destination-card">
            <div class="destination-image busan"></div>
          ...
          <div class="destination-card">
            <div class="destination-image gyeongju"></div>
          ...
          <div class="destination-card">
            <div class="destination-image seoul"></div>
  ...
  export default {
    ...
    setup() {
      ...
      onMounted(() => {
        ...
        // 배경 이미지 배열 - 여행 분위기가 물씬 나는 이미지들로 대체
        const backgroundImages = [
          'https://images.unsplash.com/photo-1506929562872-bb421503ef21?ixlib=rb-4.0.3&auto=format&fit=crop&w=1368&q=80', // 해변
          'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?ixlib=rb-4.0.3&auto=format&fit=crop&w=2071&q=80', // 로드트립
          'https://images.unsplash.com/photo-1502791451862-7bd8c1df43a7?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', // 이탈리아 친퀘테레
          'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', // 론리 비치
          'https://images.unsplash.com/photo-1533105079780-92b9be482077?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80'  // 파리
        ];
  ...
  .cta-button:hover {
    ...
    transform: translateY(-3px);
    box-shadow: 0 8px 25px rgba(72, 176, 228, 0.4);
  }
  ...
  .destination-image.jeju {
    background-image: url('@/assets/jeju.png');
  }
  
  .destination-image.busan {
    background-image: url('@/assets/busan.png');
  }
  
  .destination-image.gyeongju {
    background-image: url('@/assets/gyeonggju.png');
  }
  
  .destination-image.seoul {
    background-image: url('@/assets/gangneung.png');
  }
